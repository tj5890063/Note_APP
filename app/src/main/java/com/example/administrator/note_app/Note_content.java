...
public class Note_content extends AppCompatActivity {
         protected TextView btn_determine;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {   case R.id.item_color_white:relativeLayout.setBackgroundColor(Color.WHITE);break;
            case R.id.item_color_red:   relativeLayout.setBackgroundColor(Color.RED);break;
            case R.id.item_color_yellow :relativeLayout.setBackground(getResources().getDrawable(R.color.YELOOW));break;
            case R.id.item_color_blue :relativeLayout.setBackground(getResources().getDrawable(R.color.BULE));break;
            case R.id.item_color_green :relativeLayout.setBackground(getResources().getDrawable(R.color.GREEN));break;
        }
    ...
    private void inview() {
        ...
        relativeLayout=findViewById(R.id.content_input);
