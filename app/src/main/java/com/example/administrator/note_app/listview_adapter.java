 ...
 *    3.在geiview里面进行初始化控件
 *    4.控件建立监听器，监听器里面的内容就是调用接口对象的方法，接口对象引用界面对象，所以使用接口的对象实际上是使用界面对象重写的接口方法
...
public class listview_adapter  extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
             ...
             {   view = LayoutInflater.from(context).inflate(layout, null);
                 ...
                 viewHolder.textView_title = view.findViewById(R.id.txt_title);
                 viewHolder.textview_time = view.findViewById(R.id.txt_time);
            ...
            viewHolder.textview_time.setText(list.get(i).getTime());
